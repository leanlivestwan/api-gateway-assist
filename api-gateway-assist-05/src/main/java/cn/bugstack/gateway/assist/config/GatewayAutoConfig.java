...
public class GatewayAutoConfig {
    ...
    /**
     * 这里要创建一个Redis连接的Bean对象，这个对象在创建的过程中，需要先从Redis拉取配置信息，之后再完成注册。
     */
    @Bean
    ...
    @Bean
    public GatewayApplication gatewayApplication(GatewayServiceProperties properties, GatewayCenterService registerGatewayService,cn.bugstack.gateway.core.session.Configuration configuration, Channel gatewaySocketServerChannel) {
